# Moved to agentmail-mcp

This repository is retained as a permanent pointer for old links. The maintained AgentMail hosted MCP source now lives at [agentmail-to/agentmail-mcp](https://github.com/agentmail-to/agentmail-mcp).

- Hosted endpoint: <https://mcp.agentmail.to/mcp>
